...
export default defineConfig({
  test: {
    ...
    env: {
      ...
      SAP_MODE: 'sandbox',
      DATABASE_URL: 'postgresql://sap_user:sap_dev_password@localhost:5433/sap_triage',
      TEST_DATABASE_URL: 'postgresql://sap_user:sap_dev_password@localhost:5433/sap_triage_test',
    },
    coverage: {
      provider: 'v8',
      reporter: ['text', 'html'],
